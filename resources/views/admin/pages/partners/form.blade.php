                                    ...
                                    <div class="tab-pane fade show active" id="animated-underline-rus"
                                        ...
                                        <div class="form-group row mb-4">
                                            @include('admin.layouts.includes.form.field.input', [
                                                'label' => 'Название',
                                                'attribute' => 'ru_name',
                                                'originName' => isset($entity) ? $entity->getTranslation('name', 'ru') : null,
                                                'required' => true,
                                            ])
                                        </div>
                                        <div class="form-group row mb-12">
                                    ...
                                    <div class="tab-pane fade" id="animated-underline-kaz" role="tabpanel"
                                        ...
                                        <div class="form-group row mb-4">
                                            @include('admin.layouts.includes.form.field.input', [
                                                'label' => 'Название',
                                                'attribute' => 'kz_name',
                                                'originName' => isset($entity) ? $entity->getTranslation('name', 'kk') : null,
                                                'required' => true,
                                            ])
                                        </div>
                                        <div class="form-group row mb-12">
                                    ...
                                    <div class="tab-pane fade" id="animated-underline-en" role="tabpanel"
                                        ...
                                        <div class="form-group row mb-4">
                                            @include('admin.layouts.includes.form.field.input', [
                                                'label' => 'Название',
                                                'attribute' => 'en_name',
                                                'originName' => isset($entity) ? $entity->getTranslation('name', 'en') : null,
                                                'required' => true,
                                            ])
                                        </div>
                                        <div class="form-group row mb-12">
